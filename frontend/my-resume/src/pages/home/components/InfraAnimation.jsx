    ...
    <div className="infra-stage">
      ...
      <style>{`
        ...
        .infra-stage .node-box.active {
          stroke: var(--color-accent-primary, #C89B3C);
          stroke-width: 1.5;
        }
        ...
        [data-theme="dark"] .infra-stage .node-box.active {
          stroke: var(--color-accent-primary, #D4A94E);
        }
        ...
        .infra-stage .node-sub {
          font-family: var(--font-mono, 'Courier New', monospace);
          font-size: 7.5px;
          fill: var(--color-accent-primary, #8FA8C9);
        ...
        [data-theme="dark"] .infra-stage .node-sub {
          fill: var(--color-accent-primary, #7A9ABA);
        }
        ...
        /* ----- TRAVELING DOTS ----- */
        .infra-stage .dot {
          fill: var(--color-accent-primary, #C89B3C);
        }
